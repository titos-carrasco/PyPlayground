import rcr.jplayground.RobotThymio2;
import rcr.jplayground.RobotEPuck;
    ...
    public void run() {
        ...
        try {
            ...
            while( System.currentTimeMillis() / 1000 - t < 20 ) {
                ...
                float distanciaThymio = thymio.getProximitySensorDistances()[2];
                float distanciaEpuck = epuck.getProximitySensorDistances()[0];
